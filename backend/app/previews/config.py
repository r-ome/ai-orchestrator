...
DEFAULT_PREVIEW_MAXIMUM_DEPENDENCY_BYTES = 2_147_483_648
DEFAULT_PREVIEW_MAXIMUM_BUILT_IMAGE_BYTES = 4_294_967_296
...
class PreviewSettings:
    ...
    maximum_dependency_bytes: int = DEFAULT_PREVIEW_MAXIMUM_DEPENDENCY_BYTES
    maximum_built_image_bytes: int = DEFAULT_PREVIEW_MAXIMUM_BUILT_IMAGE_BYTES
